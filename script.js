...
function loadNames() {
    fetch('http://localhost:3000/names') // Update this URL to your backend server (e.g., if deployed)
...
function addName() {
    ...
    fetch('http://localhost:3000/submit', { // Update this URL to your backend server (e.g., if deployed)
        method: 'POST',
        headers: {
